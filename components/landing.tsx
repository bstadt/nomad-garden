                    ...
                    <div className="col-span-1 md:col-span-4 p-4 flex justify-center">
                        <div>
                            <div className="text-justify pb-8">
                                ...
                                I spend most of my time working as the right hand of the <a href={'https://en.wikipedia.org/wiki/Egregore'} className={'cursor-pointer underline'}>egregore</a> <a href={'https://nomic.ai/'} className={'cursor-pointer underline'}>Nomic</a>.
