                    ...
                    <div className="col-span-1 md:col-span-4 p-4 flex justify-center">
                        <div>
                            <div className={`text-justify pb-8 transform transition-all duration-700 ease-out delay-150 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                                ...
                                I spend most of my time thinking about <ExitLink href={'/posts/semiotic-physics'} className={'cursor-pointer underline'}>computational semiotics</ExitLink> at <a href="https://www.calcifercomputing.com" className="cursor-pointer underline" target="_blank" rel="noopener noreferrer">Calcifer</a>, an organization I founded to focus on the long-term impacts of AI on our epistemic environment.
                                As a Whiting Fellow at Johns Hopkins University, I teach <a href="https://drive.google.com/drive/folders/1_kVXXXyjIBNTmbLuIn5ZqhDLcM6inc_C?usp=sharing" className="cursor-pointer underline" target="_blank" rel="noopener noreferrer">Introduction to Computational Semiotics</a> and advise independent studies.
