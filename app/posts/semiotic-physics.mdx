...
What is it that you're doing with this tome and cork board?
Perhaps it's a piece of abstract expressionist art?
...
Achilles: Ah I see!
The picture conjured up in my mind when I hear "semiotic physics" is becoming less blurry by the second!
...
Semiotic physics is the study of the dynamics of sign production.
As we saw in the prelude, ideas like "semiotic physics" and "abstract expressionsim" have a tendency to spread and evolve by way of communication.
...
The fundamental unit of study in semiotic physics operates is the sign producing machine.
...
In the same way that [Gauss' theorem](https://en.wikipedia.org/wiki/Divergence_theorem) can be used to study the flux of a vector field through any closed surface, semiotic physics can be used to study the flux of signs through eny sign producing machine.
...
As I mention in [Violence, The State, \& Empirical Ethics](/posts/violence-and-the-state.mdx), such a model could be used to investigate the likelihood of statements across space and time by varying the conditionals.
...
I conjecture that, in the same way that human beliefs can be broken taxonomized, language models can be taxonomized.
