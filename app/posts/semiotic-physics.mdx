...
export const meta = {title: 'Towards Computational Semiotics',
...
# Towards Computational Semiotics
...
I am working on a new scientific theory I call Computational Semiotics.

Achilles: Computational Semiotics?
What on Earth does that mean?

Tortoise: A wonderful question!
Computational Semiotics is a field that uses computational methods to study the meaning-making process.
...
Before you approached me today, I imagine the phrase "computational semiotics" was senseless to you.

Achilles: Indeed it was.

Tortoise: But now that we've had some conversation about it, your understanding of the meaning of "computational semiotics" has changed.
The image that the term "computational semiotics" evokes in your mind may be blurry, but a blurry picture is much different than no picture at all.
Computational semiotics is concerned with how the meaning of terms, or more generally the meaning of *signs*, evolves as they are used to communicate.

Achilles: Ah I see!
The picture I conjure up in my mind when I hear "computational semiotics" is becoming less blurry by the second!
...
We're talking about Computational Semiotics, which studies how the meaning of signs evolves as they are used to communicate.

Crab: How fascinating! Please tell me more.

Achilles: Well, when I first happened upon Tortoise, I didn't know what Computational Semiotics meant.
But after talking with him, I gained some idea of what it means.
Now, I'm communicating that meaning to you.
Computational Semiotics tries to describe how the meaning of signs, like the term "Computational Semiotics," spreads and changes as more people communicate with each other.
...
Achilles: Now that I have talked with Crab, all three of us have "pictures" in our mind of what Computational Semiotics means.
...
What if I told you that we don't actually have to measure the "pictures" to understand what a sign means?
...
Achilles: So regardless of what pictures Crab and I have in our heads of "Computational Semiotics" the fact that we are *using* the word tells us something about its spread.
...
Tortoise: Precisely.
Based on how you are using "Computational Semiotics" I'm quite confident that you understand the spirit of my theory.
...
### Introducing Computational Semiotics
Computational Semiotics is an emerging scientific field that uses computational methods to study the meaning-making process.
As we saw in the prelude, ideas like "Computational Semiotics" and "abstract expressionism" have a tendency to spread and evolve by way of communication.
The fundamental postulate of Computational Semiotics is that we can extract precise dynamical laws describing the spread and distortion of signs by measuring how they are used.
...
The fundamental unit of study in Computational Semiotics is the sign producing machine.
...
In the same way that [Gauss' theorem](https://en.wikipedia.org/wiki/Divergence_theorem) can be used to study the flux of a vector field through any closed surface, we can study the flux of signs through any sign producing machine.

### A Research Agenda
Computational Semiotics is a very, *very* young research field, with a plethora of open questions.
...
If you have interest in working on any of these problems, *please* reach out to me at brandon \[at\] calcifercomputing \[dot\] com and I can see about getting you research resources.
...
- **UPDATE 8/15/25 :** [Cosmos Institute](https://cosmos-institute.org/) has awarded our research group a [grant](https://blog.cosmos-institute.org/p/introducing-the-first-cohort-of-ai) to build a prototype temporal language model.
...
- **UPDATE 5/22/25 :** Our [paper](https://aclanthology.org/2025.findings-acl.204.pdf) on characterizing the behavioral properties of languge model populations was published at ACL 2025.
- **UPDATE 5/6/23 :** Our research group published a [preprint](https://arxiv.org/abs/2305.05126) that characterizes the relationship between training data composition and representations learned in embedding models.
...
- **UPDATE 12/27/24 :** Our [paper](https://aclanthology.org/2024.emnlp-main.90/) on the analysis of perspective evolution in a population of language models was published at EMNLP 2024.


#### 4) Construct and Successfully Take a Measurement with a Nooscope

The nooscope is a theoretical instrument for measuring the "noosphere," or the sphere of human thought and consciousness.
In the context of Computational Semiotics, a nooscope would be a tool capable of measuring the collective semiotic state of a population of sign producing machines.
Such an instrument would allow us to empirically study phenomena including the spread and distortion of ideas.
A successful nooscope measurement would demonstrate our ability to quantify collective semiotic phenomena in a rigorous, reproducible way.
This would mark a significant milestone in the development of Computational Semiotics as an empirical science.

- **UPDATE 8/22/25 :**  Calcifer computing has been established to construct a nooscope.