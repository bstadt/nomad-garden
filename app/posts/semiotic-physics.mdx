...
**UPDATE 5/22/25 :** Our research group published a [paper](https://arxiv.org/abs/2410.01106) that lays the groundwork for understanding the relationship between a prompt and response in black box models.
...
**UPDATE 12/27/24 :** Our research group published a [paper](https://aclanthology.org/2024.emnlp-main.90/) at EMNLP 2024 detailing a method for tracking the perspectives of interacting language models.
In the paper, we demonstrate that an adversarial language model can shift the perspectives of other language models by manipulating the language that passes through their communication network.
Follow on work is planned for 2025.
