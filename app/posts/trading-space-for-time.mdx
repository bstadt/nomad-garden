...
Concretely, the [spacetime volume](https://web.mit.edu/edbert/GR/gr1.pdf) is expressed:
...
To fully appreciate the relationship between computation and spacetime volumes, we need a slightly more precise definition of physical computation.
